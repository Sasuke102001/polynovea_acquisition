"""
026_load_magicpin_step6_fitness.py
Loads fitness dimensions from step_6_output.json (MagicPin BIF) into:
  - venue_fitness_dimensions  (source='magicpin_upper')
  - behavioral_summary        (source='magicpin_upper')
  - intervention_triggers     (source='magicpin_upper')

These rows sit ALONGSIDE Google's source='google' rows.
The blend runner (027) combines both into source='blended'.
...
INTERVENTION_SQL = """
    ...
    VALUES (%s, 'magicpin_upper', %s, %s, %s, %s, %s, %s, %s, %s)
...
def main():
    print("\n026_load_magicpin_step6_fitness.py — MagicPin fitness dims → source='magicpin_upper'\n")
