...
Full post-load pipeline for a manually added venue.
...
Runs 4 steps in order:
  ...
  3. Venue vectors         — fitness vector → venue_vectors
  4. Demographics          — Bayesian segment scoring → venue_demographic_scores
